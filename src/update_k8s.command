...
~/coreos-k8s-cluster/bin/wget -N -O ./master/kube-register https://github.com/kelseyhightower/kube-register/releases/download/v$LKR/kube-register-$LKR-linux-amd64
tar czvf master.tgz *
