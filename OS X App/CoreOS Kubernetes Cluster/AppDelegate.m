...
//    NSLog(@"applicationDirectory: '%@'", _resoucesPathFromApp);
    ...
    NSString *home_folder = [NSHomeDirectory() stringByAppendingPathComponent:@"coreos-kubernetes-cluster"];
...
- (IBAction)Start:(id)sender {
        ...
        fileExistsAtPath:home_folder isDirectory:&isDir] && isDir)
    {
        ...
        notification.title = @"CoreOS-Vagrant Kubernetes Cluster will be up shortly";
...
- (IBAction)Pause:(id)sender {
    // send a notification on to the screen
    NSUserNotification *notification = [[NSUserNotification alloc] init];
    notification.informativeText = @"CoreOS-Vagrant Kubernetes Cluster will be suspended";
    [[NSUserNotificationCenter defaultUserNotificationCenter] deliverNotification:notification];
...
- (IBAction)Stop:(id)sender {
    // send a notification on to the screen
    NSUserNotification *notification = [[NSUserNotification alloc] init];
    notification.informativeText = @"CoreOS-Vagrant Kubernetes Cluster will be stopped";
    [[NSUserNotificationCenter defaultUserNotificationCenter] deliverNotification:notification];
...
- (IBAction)Restart:(id)sender {
    // send a notification on to the screen
    NSUserNotification *notification = [[NSUserNotification alloc] init];
    notification.informativeText = @"CoreOS-Vagrant Kubernetes Cluster will be reloaded";
    [[NSUserNotificationCenter defaultUserNotificationCenter] deliverNotification:notification];
...
- (IBAction)changeReleaseChannel:(id)sender {
    // send a notification on to the screen
    NSUserNotification *notification = [[NSUserNotification alloc] init];
    notification.informativeText = @"CoreOS-Vagrant Kubernetes Cluster release channel change";
    [[NSUserNotificationCenter defaultUserNotificationCenter] deliverNotification:notification];
...
- (IBAction)destroy:(id)sender {
    // send a notification on to the screen
    NSUserNotification *notification = [[NSUserNotification alloc] init];
    notification.informativeText = @"CoreOS-Vagrant Kubernetes Cluster will be destroyed";
    [[NSUserNotificationCenter defaultUserNotificationCenter] deliverNotification:notification];
...
//    NSString *app_version = [NSString stringWithFormat:@"%@.%@", version, build];
    ...
    NSString *mText = [NSString stringWithFormat:@"%@ %@", @"CoreOS-Vagrant Kubernetes Cluster for OS X", app_version];
    NSString *infoText = @"It is a simple wrapper around the CoreOS-Vagrant, which allows to control CoreOS-Vagrant Kubernetes Cluster via Status Bar !!!";
